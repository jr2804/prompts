...
1. Count lines: `wc -l file.py`
1. Read file: `Read(file_path="file.py")`
1. Count functions: `Grep(pattern="^def ", output_mode="count")`
1. Count classes: `Grep(pattern="^class ", output_mode="count")`

### Compare File Sizes

1. Find files: `Glob(pattern="src/**/*.py")`
1. Get sizes: `ls -lh src/**/*.py`
1. Total size: `du -sh src/*.py`

### Code Quality Metrics

1. Total lines: `find . -name "*.py" | xargs wc -l`
1. Test files: `find . -name "test_*.py" | wc -l`
1. TODOs: `Grep(pattern="TODO|FIXME|HACK", output_mode="count")`
